...
export const ImagesMatlacobatl = [Matlacobatl1, Matlacobatl2]
export const ImagesTexolo = [Texolo1, Texolo2]
export const ImagesMonja = [Monja1, Monja2]
export const ImagesTezozontla = [Tezozontla1, Tezozontla2]
export const ImagesTocuapan = [Tocuapan1, Tocuapan2]
export const ImagesJuntas = [Juntas1, Juntas2]
export const ImagesRevolucion = [Revolucion1, Revolucion2]
export const ImagesIglesia = [Iglesia1, Iglesia2]
export const ImagesMuseo = [Museo1, Museo2]